...
<body>
	...
	<div class="panel panel-primary">
		...
		<h1>Benvenuto!</h1>
		<p>In questa sezione potrai consultare tutti gli esami che sono
								...
								<table class="table table-hover" id="dev-table">
									...
									<tbody>
										...
										<c:forEach var="examTypology"
											...
											<tr class="info">
												<td>${examTypology.name}
												<td><h:commandLink
														action="#{examTypologyController.findExamTypology}"
														value="Altri Dettagli">
														<f:param name="id" value="#{examTypology.id}" />
													</h:commandLink></td>
