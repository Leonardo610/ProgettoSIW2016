...
<body>
	...
	<div class="panel panel-primary">
		...
		<h1>Selezione Pazienti</h1>
		<p>Scegli il paziente di cui vuoi vedere gli esami.</p>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8">
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h3 class="panel-title">Pazienti</h3>
									...
									<tbody>
										...
										<c:forEach var="patient" items="#{patientController.patients}">
											<tr class="info">
												...
												<td>${patient.name}</td>
												<td><h:commandLink
														action="#{examController.findExamByPatientAdmin}" value="profilo">

														<f:param name="idpatient" value="#{patient.id}" />
													</h:commandLink></td>
