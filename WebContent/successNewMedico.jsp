		...
		<div class="container">
			<f:view>
				...
				<table class="table">
					...
					<tbody>
						<tr class="success">
							<td>${medicController.medic.id}</td>
							<td>${medicController.medic.code}</td>
			...
			<br> <br>
			<div>
				<a href='<c:url value="./faces/newPaziente.jsp" />'>Continua ad
					inserire nuovi <i>Medici</i>
				</a>. <br> <a href='<c:url value="./faces/admin.jsp" />'>Concludi
					inserimento <i>Medici</i>
				</a>.
